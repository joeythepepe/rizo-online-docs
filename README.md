...
| File | Role |
|------|------|
| `public/brand/logo.svg` | **Rizo** brand logo (from `rizologo.svg`). Header caps: max **8 mm** tall / **48 mm** wide (`object-contain`). Also mirrored as `public/brand/rizologo.svg`. |
